  ...
  "inline-flex items-center justify-center gap-2 rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-transparent shadow-sm hover:bg-accent hover:text-accent-foreground data-[state=on]:bg-primary data-[state=on]:text-primary-foreground",
        success: "bg-transparent hover:bg-success/20 data-[state=on]:bg-success data-[state=on]:text-success-foreground",
        warning: "bg-transparent hover:bg-warning/20 data-[state=on]:bg-warning data-[state=on]:text-warning-foreground",
      },
      size: {
