...
interface UseStoryGenerationReturn {
  ...
  generateNow: (problem: string, advantages?: string, disadvantages?: string) => Promise<void>;
}
...
export const useStoryGeneration = ({
   ...
   */
  const generateNow = async (problem: string, advantages?: string, disadvantages?: string): Promise<void> => {
    if (!currentUser) {
      toast({
        title: "Error",
    ...
    try {
      ...
      const title = await generateStoryTitle(problem, advantages, disadvantages);
   ...
   */
  const generateStoryTitle = async (problem: string, advantages?: string, disadvantages?: string): Promise<string> => {
