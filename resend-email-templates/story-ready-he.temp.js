/**
 * Hebrew Story Ready Email Template
 * Template ID: STORY_READY_HE
 * 
 * Variables:
...
module.exports = {
  name: 'STORY_READY_HE',
  alias: 'STORY_READY_HE',
  from: 'Choice Story <app@choice-story.com>',
  subject: 'הסיפור שלך מוכן!',
  html: `<!DOCTYPE html>
<html lang="he" dir="rtl">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>הסיפור שלך מוכן</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f3f4f6; direction: rtl;">
  ...
  variables: [
    ...
    },
    {
      key: 'STORY_TITLE',
      type: 'string',
      fallbackValue: 'הסיפור המדהים שלך'
    }
  ]
};
